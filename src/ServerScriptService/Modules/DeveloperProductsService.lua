...
local ProductFunctions = require(ServerScriptService.Modules.ProductFunctionsService)

function DeveloperProductsService:Init()
	DeveloperProductsService:InitRecepeit()
end

function DeveloperProductsService:InitRecepeit()
