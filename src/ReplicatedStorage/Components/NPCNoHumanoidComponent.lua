...
-- Components
-- ===========================================================================
local NPCNoHumanoidComponent = Component.new({
	Tag = "NPCNoHumanoid",
	Ancestors = {
		workspace,
	},
...
function NPCNoHumanoidComponent:LoadAnimations()
...
function NPCNoHumanoidComponent:PlayAnimation(stateName)
...
function NPCNoHumanoidComponent:Construct()
...
function NPCNoHumanoidComponent:Start()
...
function NPCNoHumanoidComponent:Stop()
	self.Trove:Destroy()
end

return NPCNoHumanoidComponent
